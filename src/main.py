...
def process(image_path: Path):
    ...
    img6 = whiten_lab_gain(
        img5, face_mask, gain_l=1.14, gain_a=1.02, gain_b=0.98, k_size=51
    )
    plt.subplot(1, 2, 2)
    ...
    img8 = enlarge_eyes(
        img7, face_mask, gain=1.2, distance=(0.12, 0.12, 0.12, 0.23, 0.60), k_size=101
    )
    plt.subplot(1, 2, 2)
    ...
    new_path = image_path.with_name(image_path.stem + "_new" + image_path.suffix)
